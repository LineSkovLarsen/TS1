...
Protection of personal data is a big topic at the moment due to the new EU Legislation \textit{General Data Protection Regulation} (GDPR) that has come in to force May 2018. Though it has always been a important part of the data collection in health care, this new regulation might not change the was health providers make their equipment because a good regulation in medical devices has been established for years. When collecting the data on the patient it is important to secure these data and make sure the transmitting of data in on a secure line. If a third part  were to access protected health data by accessing electronic communications as communication a ICT solution it could potentially damage the confidentiality between the patient and the health providers. Furthermore data could be used to target the person as a consumer \cite{considerations}. A telemedicine solution should be compliant to Medical Device Regulation which is the legislation for medical devices in EU. 
...
During the implementation process ethical implications of telemedicine has to be considered to ensure privacy and confidentiality. It is a universal understanding that all patients have rights and healthcare professionals are obliged to respect those rights. When handling patient data, it is important that healthcare professional keep personal information protected. An ethical concern when using telemedicine, it that confidentiality may be more difficult to ensure. To break confidentiality can be seen as breaches of security or inappropriate disclosure of patient data. This kind of inappropriate disclosure applies both videoconferences and viewing electronic medical patient journals \cite{etik}. This  big ethical issue is the patient autonomy. It is the patients free right to choose if they want treatment and what treatment they want if multiple treatments is providable. Furthermore it is the patients right to refuse consent on distributing data or to deny acces on medical records. \\
Edward Chen explains in an article some of the considerations of implementing telemedicine one the big concerns is the lack of face-to-face interaction. Because in telemedicine has a lot of positive effects as patient acces, cost reduces, continuative care and an more active patient which can improve compliance, patient satisfaction and anxiety, but it can potentially depersonalize the health expert-patient relationship \cite{considerations}.\\ Another ethical concern is that every patient should be treated fairly and equitable. People in rural areas should have the same opportunities as people who lives in the city or near the hospitals. The only concern that collides with the use of telemedicine is that som rural areas have bad internet acces and it might create som issues though telemedicine mostly gives the patients the same equality hence it will provided in the patients home \cite{considerations}. 
The choice o
