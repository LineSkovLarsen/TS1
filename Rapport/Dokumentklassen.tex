...
\documentclass[a4paper,11pt,fleqn,dvipsnames,oneside,openany, english]{memoir} 	% Openright åbner kapitler på højresider (openany begge)
...
%\DeclareNameFormat*{default}{\ifblank{#5}{}{#5 }\ifblank{#1}{}{#1}\ifblank{#4}{}{ #4}\ifblank{#7}{}{ (#7)}\ifthenelse{\value{listcount}<\value{liststop}}{, }{}} %Udkommenteret
...
\usepackage[english]{varioref}				% Muliggør bl.a. krydshenvisninger med sidetal (\vref)
...
\setulmarginsandblock{2.5cm}{2.8cm}{*}		% \setulmarginsandblock{Top}{Bund}{Ratio}
...
\titlespacing*{\chapter}{0pt}{-20pt}{15pt} %ændre på placering af titel på kapitel
...
\makeevenhead{AAU}{\small E17BAC }{}{\leftmark}	% Definerer lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
\makeevenfoot{AAU}{}{}{\footnotesize Page \thepage\ of \thelastpage}					% Definerer lige siders sidefod (\makeevenfoot{Navn}{Venstre}{Center}{Højre})
\makeoddfoot{AAU}{}{}{\footnotesize Page \thepage\ of \thelastpage}						% Definerer ulige siders sidefod (\makeoddfoot{Navn}{Venstre}{Center}{Højre})
